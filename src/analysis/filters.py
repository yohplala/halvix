...
class TokenFilter:
    ...
    def is_stablecoin(self, coin_id: str, name: str = "", symbol: str = "") -> bool:
        ...
        stablecoin_symbols = {
            "usdt", "usdc", "dai", "usds", "usde", "pyusd", "tusd",
            "busd", "gusd", "usdp", "lusd", "frax", "mim", "gho",
            "fdusd", "usdd", "susd", "eurs", "eurt", "usdy", "usdg",
        }
    ...
    def is_btc_derivative(self, coin_id: str, name: str = "", symbol: str = "") -> bool:
        ...
        btc_derivative_ids = {
            "wbtc", "wrapped-bitcoin", "tbtc", "hbtc", "renbtc",
            "sbtc", "fbtc", "lbtc", "solvbtc", "clbtc", "cbbtc",
            "enzobtc", "arbitrum-bridged-btc",
        }
    ...
    def filter_coins(
        ...
        for coin in coins:
            ...
            if should_exclude:
                if record_filtered:
                    self.filtered_tokens.append(FilteredToken(
                        coin_id=coin_id,
                        name=name,
                        symbol=symbol,
                        reason=reason,
