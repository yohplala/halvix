...
def create_btc_usd_normalized_chart(
    ...
    for halving_date in HALVING_DATES:
        _add_cycle_extremes_lines(fig, halving_date)
...
def create_total2_dual_chart(
    ...
    # Add halving vertical lines (subplot-scoped)
    fig.add_vline(
        x=0, line={"dash": "dot", "color": "rgba(200,200,200,0.5)", "width": 2}, row=1, col=1
    )
    fig.add_vline(
        x=0, line={"dash": "dot", "color": "rgba(200,200,200,0.5)", "width": 2}, row=1, col=2
    )
    ...
    for halving_date in HALVING_DATES:
        ...
        _add_cycle_extremes_lines(fig, halving_date, row=1, col=2)
